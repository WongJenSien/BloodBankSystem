...
Route::get('edit-form-display', [InventoryController::class, 'displayInventoryForm']);
Route::post('getInventoryID', [InventoryController::class, 'show']);
Route::put('edit-inventory', [InventoryController::class, 'edit']);
...
Route::post('delete-shipment', [ShipmentController::class, 'destroy']);
...
Route::get('qrcode-scanner', [AppointmentController::class, 'scanner']);
