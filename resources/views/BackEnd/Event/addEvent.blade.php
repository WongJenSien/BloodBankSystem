        ...
        <div class="col-10" style="background-color: pink;border-radius:33px;min-height:600px;">
            <form action="{{ route('addEvent') }}" method="POST" enctype="multipart/form-data">
                ...
                <div style="text-align: center;">
                    <img src="{{ asset('storage/event/default.png') }}" class="profile-image clickable"
