                ...
                <table style="width: 100%;background-color:white;color:black;">
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="contactNumber" id="" class="form-control"
                                placeholder="Phone" value="{{ $record['contactNumber'] }}" minlength="10" maxlength="11" required></td>
                    </tr>
                    <tr>
                        <td>Email</td>
                        <td>:</td>
