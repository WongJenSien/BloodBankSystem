...
@section('content')
    ...
    @else
        ...
        <div class="container text-center mx-auto mt-3">
            {{-- BLOOOD-TYPE-A-VIEW --}}
            <div class="container border-black border">
                <div class="row mt-3">
                    {{-- LEFT-SIDE --}}
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><label for="BloodType-A-Positive"
                                                        id="BloodType-A-Positive">{{ $numOfBlood['aPositive'] }}</label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>A-</td>
                                                <td><label for="BloodType-A-Negative"
                                                        id="BloodType-A-Negative">{{ $numOfBlood['aNegative'] }}</label>
                                                </td>
                                            </tr>
                                        </tbody>
                                        <tfoot>
                                            <tr>
                                                ...
                                                <td><label for="BloodType-A-Total"
                                                        id="BloodType-A-Total">{{ $totalNumOfBlood['Blood_A'] }}</label>
                                                </td>
                                            </tr>
                                        </tfoot>
                                    </table>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><label for="BloodType-B-Positive"
                                                        id="BloodType-B-Positive">{{ $numOfBlood['bPositive'] }}</label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>B-</td>
                                                <td><label for="BloodType-B-Negative"
                                                        id="BloodType-B-Negative">{{ $numOfBlood['bNegative'] }}</label>
                                                </td>
                                            </tr>
                                        </tbody>
                                        <tfoot>
                                            <tr>
                                                ...
                                                <td><label for="BloodType-B-Total"
                                                        id="BloodType-B-Total">{{ $totalNumOfBlood['Blood_B'] }}</label>
                                                </td>
                                            </tr>
                                        </tfoot>
                                    </table>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><label for="BloodType-O-Positive"
                                                        id="BloodType-O-Positive">{{ $numOfBlood['oPositive'] }}</label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>O-</td>
                                                <td><label for="BloodType-O-Negative"
                                                        id="BloodType-O-Negative">{{ $numOfBlood['oNegative'] }}</label>
                                                </td>
                                            </tr>
                                        </tbody>
                                        <tfoot>
                                            <tr>
                                                ...
                                                <td><label for="BloodType-O-Total"
                                                        id="BloodType-O-Total">{{ $totalNumOfBlood['Blood_O'] }}</label>
                                                </td>
                                            </tr>
                                        </tfoot>
                                    </table>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><label for="BloodType-AB-Positive"
                                                        id="BloodType-AB-Positive">{{ $numOfBlood['abPositive'] }}</label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>AB-</td>
                                                <td><label for="BloodType-AB-Negative"
                                                        id="BloodType-AB-Negative">{{ $numOfBlood['abNegative'] }}</label>
                                                </td>
                                            </tr>
                                        </tbody>
                                        <tfoot>
                                            <tr>
                                                ...
                                                <td><label for="BloodType-AB-Total"
                                                        id="BloodType-AB-Total">{{ $totalNumOfBlood['Blood_AB'] }}</label>
                                                </td>
                                            </tr>
                                        </tfoot>
                                    </table>
